...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=13007}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Teleporter","color":"yellow","extra":[{"text":" (13007)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Teleporter"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Teleporter"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=13009}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Wegfindungssystem","color":"yellow","extra":[{"text":" (13009)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Wegfindungssystem"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Wegfindungssystem"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=13015}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Wahl-System","color":"yellow","extra":[{"text":" (13015)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Wahl-System"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Wahl-System"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=13016}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Gildenschlacht-Minispiel","color":"yellow","extra":[{"text":" (13016)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Gildenschlacht-Minispiel"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Gildenschlacht-Minispiel"} },{"text":"'","bold":true}]
