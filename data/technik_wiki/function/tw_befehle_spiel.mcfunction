...
execute at @s[scores={TW=20005}] run summon minecraft:firework_rocket ~ ~1 ~ {CustomName:{text:"Willkommen!",color:"gold",bold:true},CustomNameVisible:true,FireworksItem:{components:{"minecraft:fireworks":{explosions:[{colors:[16711680,16776960,255,65280],fade_colors:[255,65280,16711680,16776960],has_trail:true,has_twinkle:true,shape:"large_ball"}],flight_duration:0b} },count:1,id:"minecraft:firework_rocket"},LifeTime:20}
...
tellraw @s[scores={TW=20008}] ["",{storage:"technik_wiki:tw_daten",nbt:"TW_Info",interpret:true},{text:"Diese Welt kann im Minecraft-Technik-Wiki unter ",color:"green",bold:true},{text:"'",color:"white",bold:true},{text:"Redstone-Welt",color:"yellow",bold:true,hover_event:{action:"show_text",value:{translate:"Klick mich!"} },click_event:{action:"open_url",url:"https://de.minecraft.wiki/w/Technik:Redstone-Welt"} },{text:"'",color:"white",bold:true},{text:" heruntergeladen werden.",color:"green",bold:true}]
...
tellraw @s[scores={TW=20009}] ["",{storage:"technik_wiki:tw_daten",nbt:"TW_Info",interpret:true},{text:"Diese Welt kann im Minecraft-Technik-Wiki unter ",color:"green",bold:true},{text:"'",color:"white",bold:true},{text:"Schienen-Welt",color:"yellow",bold:true,hover_event:{action:"show_text",value:{translate:"Klick mich!"} },click_event:{action:"open_url",url:"https://de.minecraft.wiki/w/Technik:Schienen-Welt"} },{text:"'",color:"white",bold:true},{text:" heruntergeladen werden.",color:"green",bold:true}]
...
tellraw @s[scores={TW=20010}] ["",{storage:"technik_wiki:tw_daten",nbt:"TW_Info",interpret:true},{text:"Diese Welt kann im Minecraft-Technik-Wiki unter ",color:"green",bold:true},{text:"'",color:"white",bold:true},{text:"Mechanik-Welt",color:"yellow",bold:true,hover_event:{action:"show_text",value:{translate:"Klick mich!"} },click_event:{action:"open_url",url:"https://de.minecraft.wiki/w/Technik:Mechanik-Welt"} },{text:"'",color:"white",bold:true},{text:" heruntergeladen werden.",color:"green",bold:true}]
...
tellraw @s[scores={TW=20024}] [{text:" Melde Fehler im ",color:"green"},{text:"'Technik-Wiki'",color:"yellow",hover_event:{action:"show_text",value:{translate:"Klick mich!"} },click_event:{action:"open_url",url:"https://de.minecraft.wiki/w/Technik:Technik_Wiki"} },"\n",{text:" Melde Fehler im ",color:"green"},{text:"'Wiki-Discord'",color:"yellow",hover_event:{action:"show_text",value:{translate:"Klick mich!"} },click_event:{action:"open_url",url:"https://discord.com/invite/F75vfpd"} }]
...
execute if entity @s[scores={TW=20028}] run data modify storage technik_wiki:tw_daten TW_Verlauf set from entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Verlauf
...
execute if entity @s[scores={TW=20029}] run data remove entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Verlauf
...
execute if entity @s[scores={TW=20030}] store result entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Weltpunkt.X int 1 run data get entity @s Pos[0]
execute if entity @s[scores={TW=20030}] store result entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Weltpunkt.Y int 1 run data get entity @s Pos[1]
execute if entity @s[scores={TW=20030}] store result entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Weltpunkt.Z int 1 run data get entity @s Pos[2]
execute if entity @s[scores={TW=20030}] run data modify entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Weltpunkt.Welt set from entity @s Dimension
tellraw @s[scores={TW=20030}] ["",{text:"Weltpunkt gesetzt: ",color:"gray",bold:true},{entity:"@n[type=minecraft:marker,tag=TW_Eingabe]",nbt:'data."TW_Weltpunkt".X'},{text:", "},{entity:"@n[type=minecraft:marker,tag=TW_Eingabe]",nbt:'data."TW_Weltpunkt".Y'},{text:", "},{entity:"@n[type=minecraft:marker,tag=TW_Eingabe]",nbt:'data."TW_Weltpunkt".Z'},{text:" in "},{entity:"@n[type=minecraft:marker,tag=TW_Eingabe]",nbt:'data."TW_Weltpunkt".Welt'}]
...
execute if entity @s[scores={TW=20031}] run function technik_wiki:tw_befehle_weltpunkt with entity @n[type=minecraft:marker,tag=TW_Eingabe] data.TW_Weltpunkt
