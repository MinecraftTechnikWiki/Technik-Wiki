...
execute as @e[type=minecraft:armor_stand,tag=TW_Portal] at @s as @p[distance=..2,tag=TW_Portal,scores={TW_Portal=1}] at @s if block ~ ~-1 ~ minecraft:diamond_block run teleport @s -80 83 113
...
execute as @e[type=minecraft:armor_stand,tag=TW_Portal] at @s as @p[distance=..2,tag=TW_Portal,scores={TW_Portal=2}] at @s if block ~ ~-1 ~ minecraft:gold_block run teleport @s 0 54 -56
