...
summon minecraft:marker -32 90 97 {Rotation:[0.0f,0.0f],Tags:["TW_Voll","TW_Zahl","TW_Versionsnummer"]}
summon minecraft:marker -100 90 -33 {Rotation:[90.0f,0.0f],Tags:["TW_Voll","TW_Zahl","TW_Versionsnummer"]}
summon minecraft:marker 33 90 -97 {Rotation:[180.0f,0.0f],Tags:["TW_Voll","TW_Zahl","TW_Versionsnummer"]}
summon minecraft:marker 100 90 31 {Rotation:[270.0f,0.0f],Tags:["TW_Voll","TW_Zahl","TW_Versionsnummer"]}

execute at @e[type=minecraft:marker,tag=TW_Voll] run summon minecraft:marker ^-2 ^ ^ {Tags:["TW_Punkt","TW_Versionsnummer"]}
execute at @e[type=minecraft:marker,tag=TW_Voll] run summon minecraft:marker ^-8 ^ ^ {Tags:["TW_Erste","TW_Zahl","TW_Versionsnummer"]}
execute at @e[type=minecraft:marker,tag=TW_Voll] run summon minecraft:marker ^-14 ^ ^ {Tags:["TW_Zweite","TW_Zahl","TW_Versionsnummer"]}
...
scoreboard players set @e[type=minecraft:marker,tag=TW_Zahl,tag=TW_Voll] TW 1
scoreboard players operation @e[type=minecraft:marker,tag=TW_Zahl,tag=TW_Erste] TW = #TW_Erste TW
scoreboard players operation @e[type=minecraft:marker,tag=TW_Zahl,tag=TW_Zweite] TW = #TW_Zweite TW
...
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=0}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_0"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=1}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_1"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=2}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_2"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=3}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_3"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=4}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_4"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=5}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_5"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=6}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_6"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=7}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_7"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=8}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_8"}
execute at @e[type=minecraft:marker,tag=TW_Zahl,scores={TW=9}] run data merge block ~ ~ ~ {name:"technik_wiki:tw_zahl_9"}
