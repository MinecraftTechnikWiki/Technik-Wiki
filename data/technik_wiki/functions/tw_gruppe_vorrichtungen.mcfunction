...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=5001}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Kolben-Verlängerung","color":"yellow","bold":true,"extra":[{"text":" (5001)"}],"hoverEvent":{"action":"show_text","contents":{"translate":"Kolben-Verlängerung"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Technik:Kolben-Verlängerung_(Redstone)"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=5006}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Mülleimer","color":"yellow","bold":true,"extra":[{"text":" (5006)"}],"hoverEvent":{"action":"show_text","contents":{"translate":"Mülleimer"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Technik:Mülleimer_(Befehle)"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=5009}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Bewegungssensor","color":"yellow","bold":true,"extra":[{"text":" (5009)"}],"hoverEvent":{"action":"show_text","contents":{"translate":"Bewegungssensor"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Technik:Bewegungssensor_(Befehle)"} },{"text":"'","bold":true}]
...
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=5025}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Entfernungs-Sensor","color":"yellow","bold":true,"extra":[{"text":" (5025)"}],"hoverEvent":{"action":"show_text","contents":{"translate":"Entfernungs-Sensor"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Technik:Entfernungs-Sensor_(Befehle)"} },{"text":"'","bold":true}]
teleport @s[scores={TW=5025}] -292 27 -228 90 0

execute if data storage technik_wiki:tw_daten {TW_Befehl:"Uhrzeit-Sensor"} run scoreboard players set @s TW 5027
execute if data storage technik_wiki:tw_daten {TW_Befehl:"5027"} run scoreboard players set @s TW 5027
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=5027}] ["",{"translate":"Technik-Wiki-Artikel = ","color":"green","bold":true},{"text":"'","bold":true},{"text":"Uhrzeit-Sensor","color":"yellow","bold":true,"extra":[{"text":" (5027)"}],"hoverEvent":{"action":"show_text","contents":{"translate":"Uhrzeit-Sensor"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Technik:Uhrzeit-Sensor_(Befehle)"} },{"text":"'","bold":true}]
teleport @s[scores={TW=5027}] -324 27 -164 90 0
