...
item replace entity @a[tag=TW_Engel] armor.chest with minecraft:elytra[minecraft:attribute_modifiers={modifiers:[{amount:1024.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.luck",uuid:[I;1,1,1,5]},{amount:1.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.knockback_resistance",uuid:[I;1,1,1,5]},{amount:1024.0d,name:"Engel",operation:"add_multiplied_total",slot:"chest",type:"minecraft:generic.movement_speed",uuid:[I;1,1,1,5]},{amount:1024.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.max_health",uuid:[I;1,1,1,5]},{amount:1024.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.attack_speed",uuid:[I;1,1,1,5]},{amount:2048.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.attack_damage",uuid:[I;1,1,1,5]},{amount:30.0d,name:"Engel",operation:"add_value",slot:"chest",type:"minecraft:generic.armor",uuid:[I;1,1,1,5]}],show_in_tooltip:false},minecraft:enchantments={levels:{"minecraft:aqua_affinity":255,"minecraft:depth_strider":255,"minecraft:feather_falling":255,"minecraft:mending":255,"minecraft:protection":255,"minecraft:respiration":255,"minecraft:thorns":255,"minecraft:unbreaking":255},show_in_tooltip:false},minecraft:unbreakable={show_in_tooltip:false},minecraft:custom_name='{"text":"Engelsflügel","color":"light_purple","italic":false}',minecraft:custom_data={TW_Elytren:true}]
