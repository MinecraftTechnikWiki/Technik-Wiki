...
execute store result score @s[scores={TW=30001}] TW_Test run gamerule randomTickSpeed
execute store result score @s[scores={TW=30001,TW_Test=10000}] TW_Test run gamerule randomTickSpeed 100000
execute store result score @s[scores={TW=30001,TW_Test=1000}] TW_Test run gamerule randomTickSpeed 10000
execute store result score @s[scores={TW=30001,TW_Test=100}] TW_Test run gamerule randomTickSpeed 1000
execute store result score @s[scores={TW=30001,TW_Test=3}] TW_Test run gamerule randomTickSpeed 100
...
tellraw @s[scores={TW=30005}] ["",{"storage":"technik_wiki:tw_daten","nbt":"TW_Erweitert","interpret":true},{"text":"Du befindest dich im Zuschauermodus. Klicke auf einen der Spielmodi um zurück in den Spielmodus deiner Wahl zu kommen oder gelange zum Startpunkt in die Mitte der Welt, für den Kreativmodus.","color":"gold"},"\n",{"text":"Kreativ","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/trigger TW_Modus set 1"},"hoverEvent":{"action":"show_text","contents":{"text":"","extra":[{"text":"Gehe in den Kreativmodus","color":"green"}]} } },"\n",{"text":"Abenteuer","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/trigger TW_Modus set 2"},"hoverEvent":{"action":"show_text","contents":{"text":"","extra":[{"text":"Gehe in den Abenteuermodus","color":"green"}]} } },"\n",{"text":"Überleben","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/trigger TW_Modus set 3"},"hoverEvent":{"action":"show_text","contents":{"text":"","extra":[{"text":"Gehe in den Überlebensmodus","color":"green"}]} } }]
gamemode spectator @s[gamemode=!spectator,scores={TW=30005}]
execute if entity @s[scores={TW=30005}] run data modify entity @e[type=minecraft:marker,tag=TW_Eingabe,limit=1] data.TW_Befehle append value "Startzeit"
execute if entity @s[scores={TW=30005}] run data modify entity @e[type=minecraft:marker,tag=TW_Eingabe,limit=1] data.TW_Befehle append value "!Befehl"
execute if entity @s[scores={TW=30005}] run data modify entity @e[type=minecraft:marker,tag=TW_Eingabe,limit=1] data.TW_Befehle append value "Schaltfläche"
execute if entity @s[scores={TW=30005}] run data modify entity @e[type=minecraft:marker,tag=TW_Eingabe,limit=1] data.TW_Befehle append value "Nachtsicht"
...
execute if entity @s[scores={TW=30020}] at @s store success score @s TW_Test run kill @e[tag=TW_Entfernen,distance=..3,sort=nearest,limit=1]
...
tellraw @s[scores={TW=30021}] ["",{"storage":"technik_wiki:tw_daten","nbt":"TW_Erweitert","interpret":true},{"text":"Klicke hier, um der Technik einen Namen zu geben.","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"Klick mich!"} },"clickEvent":{"action":"suggest_command","value":"/data merge entity @e[distance=..3,type=minecraft:armor_stand,tag=TW_Schrift,sort=nearest,limit=1] {CustomName:\"{\\\"text\\\":\\\"Technik+Nummer\\\"}\"}"} }]
