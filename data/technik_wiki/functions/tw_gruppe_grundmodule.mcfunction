...
scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/Straßenstrecke"]}}]}] TW 1006
scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/1006"]}}]}] TW 1006
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=1006}] [" ",{"translate":"Zum Technik-Wiki-Artikel:","color":"green"},{"text":" '","bold":true},{"text":"Straßenstrecke","color":"yellow","extra":[{"text":" (1006)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Straßenstrecke"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Straßenstrecke"} },{"text":"'","bold":true}]
teleport @s[scores={TW=1006}] -252 27 -581 180 0

scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/Gleisstrecke"]}}]}] TW 1007
scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/1007"]}}]}] TW 1007
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=1007}] [" ",{"translate":"Zum Technik-Wiki-Artikel:","color":"green"},{"text":" '","bold":true},{"text":"Gleisstrecke","color":"yellow","extra":[{"text":" (1007)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Gleisstrecke"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Gleisstrecke"} },{"text":"'","bold":true}]
teleport @s[scores={TW=1007}] 251 27 260 0 0

scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/Kanalstrecke"]}}]}] TW 1008
scoreboard players set @s[nbt={Inventory:[{Slot:8b,tag:{pages:["/1008"]}}]}] TW 1008
tellraw @s[tag=!TW_Kein_Wiki,scores={TW=1008}] [" ",{"translate":"Zum Technik-Wiki-Artikel:","color":"green"},{"text":" '","bold":true},{"text":"Kanalstrecke","color":"yellow","extra":[{"text":" (1008)"}],"hoverEvent":{"action":"show_text","value":{"translate":"Kanalstrecke"} },"clickEvent":{"action":"open_url","value":"https://de.minecraft.wiki/w/Kanalstrecke"} },{"text":"'","bold":true}]
